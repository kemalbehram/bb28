...
import lotto from './router-lotto'
...
import option from './router-option'
import risk from './router-risk'
import balance from './router-balance'
import adminlog from './router-admin-log'
