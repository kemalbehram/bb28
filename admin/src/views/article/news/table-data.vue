<template>
    <div class="relative">
        ...
        <modal-create :config.sync="dataware.create" @success="createData" action="create" title="创建文章" />
        <modal-update :config.sync="dataware.update" @success="updateData" action="update" title="修改文章" />
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            dataware: {
                index: {
                    api: '/article/1000/index'
                },
                create: {
                    api: '/article/1000/create',
                    visible: false
                },
                update: {
                    api: '/article/1000/update',
                    visible: false,
                    data: { name: '' },
                    fields: [
                        'title',
