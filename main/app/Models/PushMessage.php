...
class PushMessage extends Model
{
    ...
    protected $casts = ['read' => 'bool', 'wechat' => 'bool'];

    protected $connection = 'main_sql';

    protected $fillable = ['to', 'from', 'message', 'message_type', 'index', 'read', 'read_at','wechat'];
    ...
    {
        $self = $this->current_user ? $this->current_user->id : 100000;

        $str    = str_replace($self, '', $this->index);
        $temp   = explode(':', $this->index);
        $result = '';
