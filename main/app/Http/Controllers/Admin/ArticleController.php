...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ($request->type && $request->type != 'all') && $data->where('type', $request->type);
    ...
    public function update(Request $request)
    {
        ...
        $article->thumb_wap      = $request->thumb_wap;
        $article->effective_date = $request->effective_date;
